...
- Initialize Astro Porject
```bash
astro dev init
```
Whole project strcuture will be created like this: </br>
<img width="363" height="351" alt="image" src="https://github.com/user-attachments/assets/cdf3c8aa-0d00-41c9-b451-0c8705ad7844" /> </br>
And there will be an example DAG that will be created with this code:
```bash
"""
...
example_astronauts()
```
- To run & stop a DAG, these are the commands in Astronomer
```bash
astro dev start
astro dev stop
```
- When we do "astro dev start", these docker containers will start automatically. </br>
