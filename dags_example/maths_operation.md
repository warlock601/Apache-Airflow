...
<img width="2826" height="1420" alt="image" src="https://github.com/user-attachments/assets/df18c384-6c64-4729-a2c9-fc4ee116fe05" />
</br>
</br>
In Apache Airflow, XCom (short for “Cross-Communication”) is a built-in mechanism that allows tasks within a DAG to exchange small pieces of data at runtime.
</br>
XCom allows a task to </br>
- Push data into Airflow’s metadata database. </br>
- Pull data that was pushed by another task. </br>
This is useful when task B needs the output generated by task A.</br>
Use Cases: Passing file paths generated dynamically, Passing computed values (e.g., numbers, URLs, model names), Passing configuration state.</br>
For a particular task in DAG, we casn see the "xcom", there we can see the value. </br>
</br>
<img width="2820" height="998" alt="image" src="https://github.com/user-attachments/assets/db187533-22dd-4136-9b89-7df1968cacf6" />
